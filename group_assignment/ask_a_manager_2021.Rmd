...
- Removing NA values
- Removing outliers (out of $[25\%-1.5\times IQR,75\%+1.5\times IQR]$)
...
ask_a_manager_2021 <- ask_a_manager_2021 %>% 
  mutate(
    ...
    # whether finish a college or above degree
...
reg_data <- ask_a_manager_2021 %>% 
  ...
  select(c("age_group","gender","education","field_exp","pro_exp","race","salary","research","manager","engineer","industry","analyst","data_related","scientist","database","librarian","add_context_job","add_context_inc","pop_estimate_2019_m"))
set.seed(1234)
